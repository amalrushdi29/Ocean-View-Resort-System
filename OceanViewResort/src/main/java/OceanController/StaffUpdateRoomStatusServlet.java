...
/**
 * Servlet for staff to update room status
 * Follows MVC pattern - uses RoomDao for database operations
 */
@WebServlet("/StaffUpdateRoomStatus")
public class StaffUpdateRoomStatusServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    private RoomDao roomDao;

    public StaffUpdateRoomStatusServlet() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (roomIdStr == null || roomIdStr.trim().isEmpty()) {
                ...
                response.sendRedirect("staffrooms.jsp");
                return;
            }
